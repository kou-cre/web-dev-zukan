      ...
      <MajiDialogue
        turns={[
          ...
          },
          {
            speaker: "master",
            emotion: "explain",
            text: "信号機を想像してください。\n赤から青に変えるとき、普通の変数は「値のメモ」だけ書き換える。\nでもStateのsetter関数は「値を書き換えてReactに再描画を頼む」まで一緒にやってくれる。\nだから画面が自動的に変わるんです、マジさん。",
          },
          {
            speaker: "maji",
            emotion: "question",
          ...
          },
          {
            speaker: "master",
            emotion: "standard",
            text: "値はメモリ上で変わりますが、Reactは「変わったよ」という通知を受け取れていないので再描画しません。\n画面は古いままです。\nセルフサービスのレジで支払いを済ませたのに、お知らせボタンを押し忘れた状態です。",
          },
          {
            speaker: "maji",
            emotion: "worried",
          ...
          },
          {
            speaker: "master",
            emotion: "explain",
            text: "これは「配列の分割代入」という構文です、マジさん。\nconst [a, b] = [1, 2] と書くと a に 1、b に 2 が入ります。\nuseState は [現在の値, 更新関数] という配列を返すので、分割代入で受け取っているだけです。\n名前は何でもOKですが、値とその更新関数という対で命名するのが習慣です。",
          },
          {
            speaker: "maji",
            emotion: "standard",
          ...
          },
          {
            speaker: "master",
            emotion: "explain",
            text: "その理解で完璧です。\nそしてStateが変わるたびに再レンダリングされるからこそ、「ボタンを押したらカウントが増える」「入力したら文字が表示される」というインタラクティブなUIが実現できる。\nReactの魔法の正体はここにあるんです、マジさん。",
          },
        ]}
      />
