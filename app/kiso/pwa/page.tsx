        ...
        turns={[
          {
            speaker: "maji",
            emotion: "doubt",
            text: "マスター、最近よく『PWA』って単語を見るんですけど、結局アプリとWebサイトって何が違うんですか？\nボクの中で全部混ざってしまっています……。",
          },
          {
            speaker: "master",
            emotion: "explain",
            text: "良いタイミングで聞いてくださいました、マジさん。PWAは「変身できるWebサイト」だと思ってください。\n普段はブラウザの中にいるWebサイトが、manifest.json と Service Worker という2つの仕掛けを身につけることで、ホーム画面に住みつき、オフラインでも動き、通知まで送れるアプリ風の存在に変身する。\nこれがPWAです。",
          },
          {
            speaker: "maji",
            emotion: "question",
          ...
          },
          {
            speaker: "master",
            emotion: "standard",
            text: "落ち着いてください、マジさん。確かに配布方法は劇的に楽になります。\nURLを共有するだけで、AndroidならChromeが「インストールしますか？」と提案してくれますし、iOSならSafariの「ホーム画面に追加」で同じことができます。\nストアの審査もなく、アップデートはサイトを更新するだけで全ユーザーに届く。\nただし、革命というより『選択肢が増えた』と捉えるのが冷静な見方です。",
          },
          {
            speaker: "maji",
            emotion: "worried",
          ...
          },
          {
            speaker: "master",
            emotion: "thinking",
            text: "良い疑問です。Service Worker が保存するのは、あくまでそのデバイスのブラウザキャッシュの中。\n別のサイトや別のアプリから覗かれることはありません。\n図書館でいうと「自分専用の貸出棚に本を一時的に置いておく」ようなイメージです。\nただし、機密情報まで何でも保存していいわけではなく、何をキャッシュするかは設計者が選びます。そこは普通のWebアプリと同じ責任範囲ですよ。",
          },
          {
            speaker: "maji",
            emotion: "standard",
            text: "なるほど……。つまりPWAは、Webサイトにちょっとした魔法（manifest.json + Service Worker）をかけるだけで、アプリっぽくなれるということですね。\nWebの手軽さは保ったまま、アプリの便利さを取り込む、と。",
          },
          {
            speaker: "master",
            emotion: "explain",
            text: "その通りです、マジさん。しかも嬉しいことに、Next.js プロジェクトなら next-pwa のようなライブラリを使えば、manifest.json の生成も Service Worker の登録もほぼ自動でやってくれます。\nステージ1の段階では深追い不要ですが、「ある時点でWebサイトを一気にアプリ化できるカードを持っている」と知っておくだけで、設計の選択肢がぐっと広がりますよ。",
          },
        ]}
      />
