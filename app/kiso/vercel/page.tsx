        ...
        turns={[
          {
            speaker: "maji",
            emotion: "doubt",
            text: "マスター、ボク正直に言うと「デプロイ」って言葉自体がよくわかっていないんですよ……。\n「公開する」とは言うんですけど、それって具体的に何が起きているんでしょうか？",
          },
          {
            speaker: "master",
            emotion: "explain",
            text: "正直なご質問、素晴らしいです、マジさん。\nデプロイとは、たとえるなら「自分の部屋（ローカルPC）で書いた本を、世界中の本屋に並べる作業」のことです。\nローカルでは自分しか読めない。デプロイすると初めて、地球の裏側の方からも開ける状態になるわけです。",
          },
          {
            speaker: "maji",
            emotion: "question",
          ...
          },
          {
            speaker: "master",
            emotion: "standard",
            text: "そこで Vercel の出番です。GitHub の main ブランチへ push する、それだけ。\nあとは Vercel が「梱包（ビルド）」「世界の倉庫へ配置（CDN）」「鍵の準備（HTTPS）」まで全部代行してくれます。\nマジさんの仕事は『電話をかける（push）』ことだけなのです。",
          },
          {
            speaker: "maji",
            emotion: "surprised",
          ...
          },
          {
            speaker: "master",
            emotion: "thinking",
            text: "それを Preview Deployment と申します。\nチームでレビューする際は「本番に入れる前にこのURLで動作を見せ合う」というのが定番の使い方です。\nマジさんのような個人開発者の場合でも、『main にマージする前にスマホで実機確認する』用途で十分役立ちますよ。",
          },
          {
            speaker: "maji",
            emotion: "standard",
            text: "つまり Vercel は、ボクの代わりにデプロイ作業を全部やってくれる執事みたいな存在なんですね。\nそれなら毎日push するのも怖くなくなります。",
          },
          {
            speaker: "master",
            emotion: "explain",
            text: "良い言い表しです、マジさん。実を申しますと、Vercel を使った Next.js サイトはこの仕組みで動いています。\nmain に push するたびに、数分で世界中の方が新しいページを見られるようになる。\nこれが Vercel の正体です。",
          },
        ]}
      />
