      ...
      <MajiDialogue
        turns={[
          ...
          },
          {
            speaker: "master",
            emotion: "explain",
            text: "良い着眼点ですよ、マジさん。\n確かに見た目は似ていますが、HTMLのattributeは文字列しか渡せません。\nPropsは関数・オブジェクト・真偽値・配列、何でも渡せます。\n郵便ポスト（HTMLのattribute）と宅急便（Props）の違いのようなものです。",
          },
          {
            speaker: "maji",
            emotion: "question",
          ...
          },
          {
            speaker: "master",
            emotion: "standard",
            text: "むしろ逆なんですよ、マジさん。\n「書き換え禁止」というルールがあるから、データがどこで変わったか追いやすくなります。\nキッチンが勝手に注文内容を変えたら、どんな料理が来るか分からなくなりますよね。\n変更は必ず親で行う、これがReactの安全装置です。",
          },
          {
            speaker: "maji",
            emotion: "worried",
          ...
          },
          {
            speaker: "master",
            emotion: "thinking",
            text: "これはコールバックという概念です。\n子が「何かが起きた」と親に知らせるための手段。\n宅急便で荷物を渡すとき「受け取ったら連絡してください」という連絡先（関数）も一緒に渡すイメージです。\nボタンのクリックを親に伝えるときなどに活躍しますよ。",
          },
          {
            speaker: "maji",
            emotion: "standard",
          ...
          },
          {
            speaker: "master",
            emotion: "explain",
            text: "完璧な理解です、マジさん。\nまとめると：データは親 → 子の方向にPropsで流れる。\n子から親への「報告」は関数Props（コールバック）を通じて行う。\nこの一方向の流れを守ることで、「どこで何が変わったか」が追いやすいコードになるんです。",
          },
        ]}
      />
