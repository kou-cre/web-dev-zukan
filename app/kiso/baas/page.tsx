        ...
        turns={[
          {
            speaker: "maji",
            emotion: "doubt",
            text: "マスター、BaaSってよく聞く言葉なんですけど、結局なんなんですか？\nなんかフワッとしていて、サーバーレスとかクラウドとかと何が違うのかボク全然区別ついてないんです。",
          },
          {
            speaker: "master",
            emotion: "explain",
            text: "いい質問ですよ、マジさん。BaaS は「フルオプション付きのシェアキッチン」だと思ってください。\nドアの鍵（認証）も、食材の冷蔵庫（DB）も、調理器具の棚（ストレージ）も、出前代行（Functions）も、ぜんぶ最初から備え付けられている。\n自分はそこへ行ってコードを書くだけでよい、というサービスです。",
          },
          {
            speaker: "maji",
            emotion: "question",
          ...
          },
          {
            speaker: "master",
            emotion: "thinking",
            text: "落ち着いてください、マジさん。サーバーが消えたわけではありません。\nBaaS提供側のサーバーが、マジさんの代わりに動いているだけです。\nたとえるなら「自分の家を持たずに、ホテルに泊まり続けている」ようなもの。\n家を建てる手間はないけれど、ホテル（クラウド事業者）の建物は確かに存在しています。",
          },
          {
            speaker: "maji",
            emotion: "doubt",
            text: "なるほど……。あ、それで気になったんですけど、BaaSって Firebase と Supabase ってのがあるじゃないですか。\nボクどっち選べばいいのか全然わからないんです。これ間違えたら一生取り返しがつかないんじゃ……！",
          },
          {
            speaker: "master",
            emotion: "explain",
            text: "大袈裟ですよ、マジさん。最初は Firebase からで構いません。\nGoogle製で資料も多く、個人開発の最初のステップとして十分な選択肢です。\nSQL を書いたご経験があるなら Supabase（PostgreSQLベース）も自然な選択肢になります。\nですが、今は道具を選ぶことより、選んだ道具を使いこなすことに集中するのが先です。",
          },
          {
            speaker: "maji",
            emotion: "standard",
            text: "つまり、BaaS を「使う」のと「依存する」のは違う、ということですね。\nBaaS の裏で何が動いているかを知らないままだと、いざ問題が起きたときに動けないと。",
          },
          {
            speaker: "master",
            emotion: "explain",
            text: "その通りです、マジさん。BaaS の中身は、前回お話しした「HTTPサーバー＋処理ロジック＋DB接続＋外部API連携」がクラウド側で動いているだけ。\n構造を知っていれば、後でステージ2に進んだときに地続きで理解できます。\n今日のところは「BaaS＝バックエンド全部入りのシェアキッチン」、これだけ持ち帰っていただければ合格ですよ。",
          },
        ]}
      />
